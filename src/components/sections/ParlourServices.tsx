...
export const ParlourServices = () => {
  ...
  const services = [
    ...
    { key: 'service_4', icon: 'solar:hand-money-bold' },
    { key: 'service_5', icon: 'solar:buildings-bold' },
    { key: 'service_6', icon: 'solar:chart-2-bold' },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          {services.map((service, index) => (
            ...
            >
              ...
              <div>
                <h3 className="text-xl lg:text-2xl font-serif text-brand-dark group-hover:text-brand-alabaster leading-tight transition-colors mb-4 uppercase">
                  {t(`${service.key}_title`)}
                </h3>
                <p className="text-brand-dark/60 group-hover:text-brand-alabaster/70 transition-colors leading-relaxed">
                  {t(`${service.key}_desc`)}
                </p>
              </div>
            </div>
