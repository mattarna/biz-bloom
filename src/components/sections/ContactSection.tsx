...
export const ContactSection = () => {
  ...
  return (
    <div className="bg-brand-alabaster">
        ...
        sideElement={
          <div className="relative">
            <div className="aspect-[4/5] relative overflow-hidden shadow-2xl">
              <Image 
                src="/media/image-pages/biz-bloom-image (3).webp" 
      ...
      <section className="relative py-24 lg:py-40 bg-brand-alabaster overflow-hidden min-h-[50vh]">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
              <div className="flex items-center gap-8">
                <div className="hidden lg:block relative h-24 w-24 overflow-hidden rounded-full border border-brand-dark/10">
                  <Image 
                    src="/media/image-pages/biz-bloom-image (4).webp"
                    alt="Hub"
                    fill
